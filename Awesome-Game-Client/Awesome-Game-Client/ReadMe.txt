========================================================================
    KONSOLENANWENDUNG: Awesome-Game-Client-Projektübersicht
========================================================================

Diese Awesome-Game-Client-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Awesome-Game-Client-Anwendung besteht.


Awesome-Game-Client.vcxproj
...
Awesome-Game-Client.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Awesome-Game-Client.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
